...
<experiments>
  ...
  <experiment name="Scenario A1 (sostituzione prodotto)" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="700"/>
    <metric>mean-excluding-zeros sa-purchases</metric>
  ...
  <experiment name="Scenario n-agents (repr TRUE)" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="700"/>
    <metric>mean-excluding-zeros sa-purchases</metric>
