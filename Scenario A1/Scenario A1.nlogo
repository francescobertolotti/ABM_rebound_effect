...
to setup
  ...
  if food-industry [
    init-globals-food
    set file-name-m1 "Reprocessing_matrix_food3.csv"
...
to init-globals-food
  ...
  set ticks-scenario 200     ;circa l'ultimo 30% della simulazione (700 ticks)
  set beta-baseline 0
...
<experiments>
  ...
  <experiment name="Scenario B" repetitions="10" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="file-name-m1">
      <value value="&quot;Reprocessing_matrix_fashion_B.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="file-name-m2">
      <value value="&quot;Input_data_products_fashion_B.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="trigger-max">
      <value value="2"/>
    </enumeratedValueSet>
  ...
  <experiment name="Scenario con matrice2" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="700"/>
    <metric>mean-excluding-zeros sa-purchases</metric>
    ...
    <enumeratedValueSet variable="file-name-m1">
      <value value="&quot;Reprocessing_matrix_food2.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="file-name-m2">
      <value value="&quot;Input_data_products_food.csv&quot;"/>
    </enumeratedValueSet>
  ...
  <experiment name="Scenario con matrice3" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="700"/>
    <metric>mean-excluding-zeros sa-purchases</metric>
    ...
    <enumeratedValueSet variable="file-name-m1">
      <value value="&quot;Reprocessing_matrix_food3.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="file-name-m2">
      <value value="&quot;Input_data_products_food.csv&quot;"/>
    </enumeratedValueSet>
