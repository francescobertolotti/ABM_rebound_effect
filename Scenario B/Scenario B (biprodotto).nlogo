;problems to be solved/adressed: look for CHECK or FIX or REVIEW or MODIFICA
...
[
  ...
  trigger              ;propensity to purchase
...
globals [
  ...
  sa-price-primary-class-0
  sa-price-primary-class-1
  sa-price-reprocessed-class-0
  sa-price-reprocessed-class-1
...
to setup
  ...
  if food-industry [
    ...
    set file-name-m2 "Input_data_products_food_biproduct.csv"
  ]
...
to init-globals-food
  ...
  set c-strategy-frequency 2
  set ss-multiplier 5        ; deve essere abbastanza alto da fare in modo che ci fosse sempre (anche in presenza di pochi utenti) waste in modo da generare riprocessati
  ...
  set sa-price-primary-class-0 []  ;queste due liste servono per separare i prezzi dei primary e dei reprocessed della classe FV e RTE
  set sa-price-primary-class-1 []
  set sa-price-reprocessed-class-0 []
  set sa-price-reprocessed-class-1 []



  set ticks-scenario 300     ;circa l'ultimo 30% della simulazione (700 ticks)
  set beta-baseline 0
...
to for-scenario-analysis
  ...
  set sa-price-primary-class-0 lput (mean [p-price] of products with [primary-prod = 1 and p-name = item 0 p-name-list]) sa-price-primary-class-0
  set sa-price-primary-class-1 lput (mean [p-price] of products with [primary-prod = 1 and p-name = item 1 p-name-list]) sa-price-primary-class-1
  ...
  ifelse (count products with [primary-prod = 0] =  0)
    [
      ...
      set sa-price-reprocessed-class-0 lput (0) sa-price-reprocessed-class-0
      set sa-price-reprocessed-class-1 lput (0) sa-price-reprocessed-class-1
    ]
    ...
    ifelse (count products with [primary-prod = 0 and p-name = item 0 p-name-list] = 0)
    [ set sa-price-reprocessed-class-0 lput (0) sa-price-reprocessed-class-0
    ]
      [set sa-price-reprocessed-class-0 lput (mean [p-price] of products with [primary-prod = 0 and p-name = item 0 p-name-list]) sa-price-reprocessed-class-0
    ]
    ifelse (count products with [primary-prod = 0 and p-name = item 1 p-name-list] = 0)
    [set sa-price-reprocessed-class-1 lput (0) sa-price-reprocessed-class-1
    ]
      [set sa-price-reprocessed-class-1 lput (mean [p-price] of products with [primary-prod = 0 and p-name = item 1 p-name-list]) sa-price-reprocessed-class-1
    ]
    ]


  if (ticks > ticks-scenario)                                 ;qui aggiorniamo le liste (tenendone fissa la lunghezza a 200) <-> "se hai già superato la lunghezza di 200, togli un elemento e aggiungine un altro"
  [
    ...
    set sa-price-primary-class-0 but-first sa-price-primary-class-0
    set sa-price-primary-class-1 but-first sa-price-primary-class-1
  ...
  set sa-purch-class-6 but-first  sa-purch-class-6
    ...
    set sa-price-reprocessed-class-0 but-first sa-price-reprocessed-class-0
    set sa-price-reprocessed-class-1 but-first sa-price-reprocessed-class-1
  ]
...
517
NIL
Count products with [primary-prod = 0]
17
1
11
...
<experiments>
  ...
  <experiment name="Scenario n-agents" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
    <metric>mean-excluding-zeros sa-purchases</metric>
  ...
  <experiment name="Scenario B (biprodotto)" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="700"/>
    <metric>mean-excluding-zeros sa-purchases</metric>
    ...
    <metric>mean-excluding-zeros sa-price-global-reprocessed</metric>
    <metric>mean-excluding-zeros sa-reprocessed-%</metric>
    <metric>mean-excluding-zeros sa-purch-repr</metric>
    <metric>mean-excluding-zeros sa-price-primary-class-0</metric>
    <metric>mean-excluding-zeros sa-price-primary-class-1</metric>
    <metric>mean-excluding-zeros sa-price-reprocessed-class-0</metric>
    <metric>mean-excluding-zeros sa-price-reprocessed-class-1</metric>
    <enumeratedValueSet variable="n-companies">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="n-users">
    ...
    <enumeratedValueSet variable="file-name-m2">
      <value value="&quot;Input_data_products_food_biproduct.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="trigger-max">
      <value value="2"/>
    </enumeratedValueSet>
  ...
  <experiment name="Scenario sostituzione" repetitions="10" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="file-name-m1">
      <value value="&quot;Reprocessing_matrix_fashion.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="file-name-m2">
      <value value="&quot;Input_data_products_fashion.csv&quot;"/>
    </enumeratedValueSet>
  ...
  <experiment name="Scenario_purchases 1 vs 0" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
    <metric>mean-excluding-zeros sa-purchases</metric>
